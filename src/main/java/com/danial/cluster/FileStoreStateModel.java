...
public class FileStoreStateModel extends StateModel {
    ...
    public void onBecomeMasterFromSlave(final Message message, NotificationContext context) throws IOException {
        replicator.stop();
        System.out.println(_serverId + " transitioning from " + message.getFromState() + " to " + message.getToState() + " for " + _partition);
    ...
    public void onBecomeSlaveFromMaster(Message message, NotificationContext context) throws Exception {
        service.stop();
        LOG.info(_serverId + " transitioning from " + message.getFromState() + " to " + message.getToState() + " for " + _partition);
        replicator.start();
    }
