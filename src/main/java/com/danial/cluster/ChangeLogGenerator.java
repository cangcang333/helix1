...
public class ChangeLogGenerator implements FileChangeWatcher{
    ...
    public ChangeLogGenerator(String directory, long startGen, long startSeq) throws FileNotFoundException {
    ...
    private void write(ChangeRecord record) throws IOException {
